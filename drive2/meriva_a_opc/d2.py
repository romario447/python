...
chat_id = '-1001160418265'	#Vesta chat
#test_chat_id = '-1001499088147' #test chat
admin_chat_id = '219922526'
url = 'https://www.drive2.ru/cars/opel/meriva/g1719/' #URL Vesta
url_path = '/home/ubuntu/python/drive2/meriva_a_opc/link.txt'
HEADERS = {
...
if (link != current_link):
    ...
    bot.send_message(admin_chat_id, 'Новый пост про Meriva A OPC найден и опубликован на канал ' + link)
    ...
    bot = telebot.TeleBot(bot_id)
    bot.send_message(admin_chat_id, 'Новых постов про Meriva A OPC нет')
