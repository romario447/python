...
url = 'https://www.drive2.ru/cars/opel/meriva/g1718/' #URL Vesta
url_path = '/home/ubuntu/python/drive2/meriva_a/link.txt'
HEADERS = {
...
if (link != current_link):
    ...
    bot.send_message(admin_chat_id, 'Новый пост про Meriva A найден и опубликован на канал ' + link)
    ...
    bot = telebot.TeleBot(bot_id)
    bot.send_message(admin_chat_id, 'Новых постов про Meriva A нет')
