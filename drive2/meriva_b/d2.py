...
chat_id = '-1001372680528'	#Meriva B chat
#test_chat_id = '-1001499088147' #test chat
admin_chat_id = '219922526'
url = 'https://www.drive2.ru/cars/opel/meriva/g3530/' #URL Vesta
url_path = '/home/ubuntu/python/drive2/meriva_b/link.txt'
HEADERS = {
...
if (link != current_link):
    ...
    bot.send_message(admin_chat_id, 'Новый пост найден и опубликован на канал Meriva B ' + link)
    ...
    bot = telebot.TeleBot(bot_id)
    bot.send_message(admin_chat_id, 'Новых постов про Meriva B нет')
